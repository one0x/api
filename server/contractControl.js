...
exports = module.exports = function(app) {
    ...
    function unlockSpecificAndReturn(unlockAccount, accountPassword) {
        return new Promise(function(resolve, reject) {
            ...
            KarmaContract.defaults({from: unlockAccount, gas: 4500000, gasPrice: 60000000000});
    ...
    function loadContracts() {
        ...
        CollectionContract.defaults({from: app.get('blockProducerAddress'), gas: 4500000, gasPrice: 60000000000});
        ...
        KarmaContract.defaults({from: app.get('blockProducerAddress'), gas: 4500000, gasPrice: 60000000000});
        KarmaContract.deployed()
            .then(function(instance) {
        ...
        GyanContract.defaults({from: app.get('blockProducerAddress'), gas: 4500000, gasPrice: 60000000000});
        ...
        ScholarshipContract.defaults({from: app.get('blockProducerAddress'), gas: 4500000, gasPrice: 60000000000});
        ...
        QuestionContract.defaults({from: app.get('blockProducerAddress'), gas: 4500000, gasPrice: 60000000000});
